 ...
 * @author User
 */
public class frameBiayaJasa extends javax.swing.JFrame {
    
    private dsBiayaJasa BiayaJasa;
    public frameBiayaJasa() {
        initComponents();
        this.setLocationRelativeTo(null);
        BiayaJasa = new dsBiayaJasa();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM BIAYA JASA");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(btnTambahData, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cmbJenisLayanan, 0, 140, Short.MAX_VALUE)
                                    .addComponent(txtHarga))))
                        .addGap(18, 18, 18)
                        .addComponent(txtIndex, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnTambahDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahDataActionPerformed
        ...
        BiayaJasa.insertjenisLayanan(cmbJenisLayanan.getSelectedItem().toString());
        BiayaJasa.insertharga(Integer.valueOf(txtHarga.getText()));
    ...
    private void btnBacaDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBacaDataActionPerformed
        ...
        String isiArray = "JenisLayanan : " + BiayaJasa.getRecordjenisLayanan().get(i)+
                          "\nHarga : " + BiayaJasa.getRecordharga().get(i);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameBiayaJasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
